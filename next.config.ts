...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/plant-doctor", destination: "/doctor", permanent: true },
      { source: "/daktari", destination: "/doctor", permanent: true },
      { source: "/sw/daktari", destination: "/doctor", permanent: true },
      {
