    ...
    return (
      <div className="flex items-center gap-3 text-sm text-soil-400">
        ...
        <div>
          ...
          <span>MSc Agricultural Engineering</span>
          <span className="mx-1.5 text-soil-300">·</span>
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-soil-500 mt-1 leading-relaxed">
            MSc Agricultural Environmental Management Engineering,{" "}
            ...
            on iSDAsoil 30-metre satellite data. Former researcher in geostatistical 
            heavy-metal soil analysis. 4× Coursera SEO certified.
          </p>

          {/* Credential badges */}
          <div className="flex flex-wrap gap-2 mt-3">
            {[
              "MSc Agri. Engineering",
              "BBA",
              "iSDAsoil Specialist",
              "4× SEO Certified",
            ].map((badge) => (
