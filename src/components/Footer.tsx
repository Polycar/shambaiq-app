        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link href="/intercrop" className="hover:text-gold-400 transition-colors">Intercropping guide</Link></li>
              <li><Link href="/crop-finder" className="hover:text-gold-400 transition-colors">Crop finder</Link></li>
              <li><Link href="/seeds" className="hover:text-gold-400 transition-colors">Certified seeds</Link></li>
              <li><Link href="/features" className="hover:text-gold-400 transition-colors">All features</Link></li>
