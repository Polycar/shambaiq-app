      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="prose prose-forest max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="text-soil-500 leading-relaxed mb-4">If your soil is acidic, you should also use Mavuno or YaraMila instead of standard DAP for planting fertilizer. These blends are formulated for acidic conditions and include micronutrients that help mitigate aluminium toxicity. See our <Link href="/blog/dap-vs-can-vs-npk-fertilizer-guide" className="text-gold-600 hover:underline font-medium">fertilizer comparison guide</Link> for details. Additionally, building organic matter helps buffer pH fluctuations; learn how to do this in our <Link href="/blog/organic-soil-enrichment-kenya-soil-carbon" className="text-gold-600 hover:underline font-medium">soil organic carbon restoration guide</Link>.</p>
          </section>

          <section className="mb-10">
            <h2 className="font-display text-2xl font-bold text-forest-700 mb-4">Crops That Tolerate Acidity</h2>
            <p className="text-soil-500 leading-relaxed mb-4">While liming is the long-term solution, some crops handle acidic soil better than others. <Link href="/crops/tea" className="text-gold-600 hover:underline font-medium">Tea</Link> actually prefers acidic conditions (pH 4.5–5.5), which is why it thrives in the Central Highlands. <Link href="/crops/potatoes" className="text-gold-600 hover:underline font-medium">Potatoes</Link> tolerate pH as low as 5.2 (read our <Link href="/blog/meru-nyeri-potato-farming-guide" className="text-gold-600 hover:underline font-semibold">Meru & Nyeri potato guide</Link> for detailed practices), and <Link href="/crops/sweet-potato" className="text-gold-600 hover:underline font-medium">sweet potatoes</Link> can handle even lower (see our <Link href="/blog/sweet-potato-farming-homa-bay" className="text-gold-600 hover:underline font-semibold">Homa Bay sweet potato guide</Link> for potassium bulking tips). Sensitive brassicas like cabbages require defensive buffering (read our <Link href="/blog/cabbage-farming-kiambu" className="text-gold-600 hover:underline font-semibold">Kiambu cabbage guide</Link> for clubroot defense). Legumes like dry beans face severe nodulation failure under acidity without seed inoculation (see our <Link href="/blog/bean-farming-kakamega" className="text-gold-600 hover:underline font-semibold">Kakamega bean guide</Link>).</p>
